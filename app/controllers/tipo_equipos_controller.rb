class TipoEquiposController < ApplicationController
  ...
  def index
    ...
    @tipo_equipos = TipoEquipo.paginate(:page => params[:page], :per_page => 9)
    render 'tipo_equipos/list'
  end
  ...
  private
    ...
    def tipo_equipo_params
      params.require(:tipo_equipo).permit(:descripcion)
    end
end
