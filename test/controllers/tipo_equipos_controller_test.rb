...
class TipoEquiposControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tipo_equipo" do
    assert_difference('TipoEquipo.count') do
      post tipo_equipos_url, params: { tipo_equipo: { descripcion: @tipo_equipo.descripcion } }
    end
  ...
  test "should update tipo_equipo" do
    patch tipo_equipo_url(@tipo_equipo), params: { tipo_equipo: { descripcion: @tipo_equipo.descripcion } }
